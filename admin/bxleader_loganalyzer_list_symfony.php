...
$obAdminListHelper->setTitle(Loc::getMessage('BM_LA_SYMFONY_TITLE'));
...
$sDirectory    = Option::get(ADMIN_MODULE_NAME, 'symfony_log_path');
$bRecursive    = Option::get(ADMIN_MODULE_NAME, 'symfony_log_recursive') == 'Y';

// дата-провайдер

$obDataProvider = new DataProvider($sFileProvider, $bShowQueries);
$obDataProvider->setLogSettings('symfony', $sDirectory, $bRecursive);
