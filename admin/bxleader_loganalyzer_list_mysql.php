...
$obAdminListHelper->setTitle(Loc::getMessage('BM_LA_' . strtoupper(BxHelper::getDbFork()) . '_TITLE'));
...
$sDirectory    = Option::get(ADMIN_MODULE_NAME, 'mysql_log_path');
$bRecursive    = Option::get(ADMIN_MODULE_NAME, 'mysql_log_recursive') == 'Y';

// дата-провайдер

$obDataProvider = new DataProvider($sFileProvider, $bShowQueries);
$obDataProvider->setLogSettings('mysql', $sDirectory, $bRecursive);
