...
$obAdminListHelper->setTitle(Loc::getMessage('BM_LA_YII_TITLE'));
...
$sDirectory    = Option::get(ADMIN_MODULE_NAME, 'yii_log_path');
$bRecursive    = Option::get(ADMIN_MODULE_NAME, 'yii_log_recursive') == 'Y';

// дата-провайдер

$obDataProvider = new DataProvider($sFileProvider, $bShowQueries);
$obDataProvider->setLogSettings('yii', $sDirectory, $bRecursive);
