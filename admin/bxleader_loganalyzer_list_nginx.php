...
$obAdminListHelper->setTitle(Loc::getMessage('BM_LA_NGINX_TITLE'));
...
$sDirectory    = Option::get(ADMIN_MODULE_NAME, 'nginx_log_path');
$bRecursive    = Option::get(ADMIN_MODULE_NAME, 'nginx_log_recursive') == 'Y';

// дата-провайдер

$obDataProvider = new DataProvider($sFileProvider, $bShowQueries);
$obDataProvider->setLogSettings('nginx', $sDirectory, $bRecursive);
