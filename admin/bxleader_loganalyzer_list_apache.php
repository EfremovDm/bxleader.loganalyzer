...
$obAdminListHelper->setTitle(Loc::getMessage('BM_LA_APACHE_TITLE'));
...
$sDirectory    = Option::get(ADMIN_MODULE_NAME, 'apache_log_path');
$bRecursive    = Option::get(ADMIN_MODULE_NAME, 'apache_log_recursive') == 'Y';

// дата-провайдер

$obDataProvider = new DataProvider($sFileProvider, $bShowQueries);
$obDataProvider->setLogSettings('apache', $sDirectory, $bRecursive);
...
$obAdminListHelper->setFilter(array(
    ...
    'ip'            => array('TITLE' => Loc::getMessage('BM_LA_FILTER_IP')),
