...
$obAdminListHelper->setTitle(Loc::getMessage('BM_LA_PHP_TITLE'));
...
$sDirectory    = Option::get(ADMIN_MODULE_NAME, 'php_log_path');
$bRecursive    = Option::get(ADMIN_MODULE_NAME, 'php_log_recursive') == 'Y';

// дата-провайдер

$obDataProvider = new DataProvider($sFileProvider, $bShowQueries);
$obDataProvider->setLogSettings('php', $sDirectory, $bRecursive);
